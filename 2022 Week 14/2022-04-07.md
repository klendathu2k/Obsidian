...
- sPHENIX production system
	...
	- [Conditional workflow](https://panda-wms.readthedocs.io/en/latest/client/pchain.html#conditional-workflow) is supported... along with javascript expressions... so should be able to manage providing PanDA args based on whether they are set or not on the yaml file.