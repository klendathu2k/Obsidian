...
NOTE:  I do not believe that PanDA has an appropriate default here.... IMHO (actually, IM-not-so-HO) the default should be to launch one job per input file.  i.e. default mechanism should be scatter.  SHREK may set this up as the default behavior.
